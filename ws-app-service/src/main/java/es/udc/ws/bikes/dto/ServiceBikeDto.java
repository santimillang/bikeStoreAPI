...
public class ServiceBikeDto {
	...
	public ServiceBikeDto(Long bikeId, String model, String description, Calendar firstDate, float price, Long units,
	...
	public String toString() {
		return "ServiceBikeDto [bikeId=" + bikeId + ", model=" + model + ", description=" + description + ", firstDate="
